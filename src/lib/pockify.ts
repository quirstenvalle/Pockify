...
export const SEED_TRANSACTIONS: Transaction[] = [
  ...
  t("expense", 250, "Food", 0, "Lunch with team"),
  t("expense", 80, "Transportation", 0, "Bus fare", true),
  t("expense", 900, "Grocery", 0, "Weekly groceries"),
  t("expense", 120, "Food", 1, "Rice bowl", true),
  t("expense", 65, "Coffee", 1, "Latte"),
  t("expense", 1500, "Bills", 2, "Electricity"),
  t("expense", 340, "Healthcare", 3, "Vitamins"),
  t("expense", 220, "Education", 4, "Notebook + pens"),
  t("expense", 1800, "Shopping", 5, "New sneakers"),
  t("expense", 480, "Entertainment", 6, "Movie night"),
  t("expense", 95, "Coffee", 6, "Cold brew"),
  t("expense", 130, "Transportation", 7, "Grab ride"),
  t("expense", 720, "Grocery", 9, "Pantry restock"),
